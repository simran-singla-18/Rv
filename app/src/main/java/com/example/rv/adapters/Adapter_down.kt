...
import com.example.rv.onClickInterface

class Adapter_down (val context: Context, val list:List<Item>, val onClickInterface: onClickInterface): RecyclerView.Adapter<Adapter_down.ViewHolder>() {
    class ViewHolder(ItemView: View): RecyclerView.ViewHolder(ItemView){
        val constraintLayout:ConstraintLayout=itemView.findViewById(R.id.itemTile)
